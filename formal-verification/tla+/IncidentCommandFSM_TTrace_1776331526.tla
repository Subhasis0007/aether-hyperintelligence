---- MODULE IncidentCommandFSM_TTrace_1776331526 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("IncidentCommandFSM_TTrace_1776331526.json", _TETrace)
...
\*
\*trace == IODeserialize("IncidentCommandFSM_TTrace_1776331526.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([escalated |-> FALSE,iteration |-> 0,state |-> "DIAGNOSING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 1,state |-> "FIXING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 1,state |-> "VERIFYING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 1,state |-> "DIAGNOSING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 2,state |-> "FIXING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 2,state |-> "VERIFYING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 2,state |-> "DIAGNOSING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 3,state |-> "FIXING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 3,state |-> "VERIFYING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 3,state |-> "DIAGNOSING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 4,state |-> "FIXING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 4,state |-> "VERIFYING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 4,state |-> "DIAGNOSING",activeAgents |-> {},resolved |-> FALSE]),
    ([escalated |-> FALSE,iteration |-> 5,state |-> "FIXING",activeAgents |-> {},resolved |-> FALSE])
    >>
----
...
---- CONFIG IncidentCommandFSM_TTrace_1776331526 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Apr 16 14:55:28 IST 2026