---- MODULE IncidentCommandFSM_TTrace_1776331706 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("IncidentCommandFSM_TTrace_1776331706.json", _TETrace)
...
\*
\*trace == IODeserialize("IncidentCommandFSM_TTrace_1776331706.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([escalated |-> FALSE,iteration |-> 0,state |-> "TRIAGING",activeAgents |-> {"Diag", "Fix", "Comms"},resolved |-> FALSE]),
...
---- CONFIG IncidentCommandFSM_TTrace_1776331706 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Apr 16 14:58:28 IST 2026